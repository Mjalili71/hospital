            ...
            <div style="padding:70px;" align="center" >
                <table  >
                    <tr style="background-color: black;">
                        ...
                        <th style="padding: 10px; font-size:20px; color:white">Statuse</th>
                    ...
                    <tr style="background-color: black" align="center">
                        ...
                        <td style="padding: 10px;  color:white">{{$appoints->statuse}}</td>
                        <td style="padding: 10px;  color:white"><a class="btn btn-danger"  onclick="return confirm('are youe sure to delete this?')"
